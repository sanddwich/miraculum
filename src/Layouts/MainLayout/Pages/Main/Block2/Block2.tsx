  ...
  return (
    <Element name="Block2">
      <Container className="Block2">
        <AnimationOnScroll animateOnce={true} offset={150} animateIn="animate__fadeInRight">
          <h1>Что мы делаем?</h1>
        </AnimationOnScroll>
        ...
        <Row className="Block2__Row">
          <Col md={6} className="Block2__Left d-flex justify-content-end align-items-center">
            <AnimationOnScroll animateOnce={true} offset={150} duration={2} delay={500} animateIn="animate__fadeIn">
